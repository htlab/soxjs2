...
var connEventListener = {
  onConnecting: function() {
    console.log('@@@@ event listener: connecting');
  ...
  onDisconnecting: function() {
    console.log('@@@@ event listener: disconnecting');
  ...
  onFail: function() {
    console.log('@@@@ event listener: fail');
...
var connectionEventListenerId = conn.addConnectionEventListner(connEventListener);
console.log("@@@ connectionEventListenerId=" + connectionEventListenerId);
